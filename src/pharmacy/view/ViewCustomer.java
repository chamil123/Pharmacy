...
public class ViewCustomer extends javax.swing.JPanel {
    ...
    public ViewCustomer() {
        ...
        dtm.setRowCount(0);
        for (Customer c : list) {
            Object[] row = {c.getCus_id(), c.getCus_firstName()+" "+c.getCus_lastName(), c.getCus_address(), c.getCus_IDNumber(), c.getCus_email(), c.getCus_IDNumber()};
...
//        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#Customer ID", "Customer Name", "Address", "Mobile Number", "Email", "NIC Number"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String customerId = dtm.getValueAt(row, 0).toString();

        UpdateCustomer dialog = new UpdateCustomer(new javax.swing.JFrame(), true, customerId);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        try {
            ...
            List<Customer> customerList = CustomerController.searchCustomerByName(jTextField1.getText());
            ...
            if (customerList != null) {
                for (int i = 0; i < customerList.size(); i++) {
                    ...
                    Vector v = new Vector();
                    v.add(customerList.get(i).getCus_id());
                    v.add(customerList.get(i).getCus_firstName()+" "+customerList.get(i).getCus_lastName());
                    v.add(customerList.get(i).getCus_address());
                    v.add(customerList.get(i).getCus_mobile());
                    v.add(customerList.get(i).getCus_email());
                    v.add(customerList.get(i).getCus_IDNumber());
