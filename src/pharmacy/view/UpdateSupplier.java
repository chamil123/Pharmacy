...
int sup_id=0;
    ...
    UpdateSupplier(JFrame jFrame, boolean b, String supplierId) {
        try {
            initComponents();
            setLocationRelativeTo(this);
            
            Supplier supplier=SupplierController.searchSupplierById(supplierId);
            sup_id=supplier.getSup_id();
            jTextField1.setText(supplier.getSup_name());
            jTextField2.setText(supplier.getSup_companyName());
            jTextField3.setText(supplier.getSup_IDnumber());
            jTextField5.setText(supplier.getSup_email());
            jTextArea1.setText(supplier.getSup_address());
            jTextField4.setText(supplier.getSup_teliphone());
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Supplier_1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Supplier supplier = new Supplier(sup_id, jTextField1.getText(), jTextArea1.getText(), jTextField4.getText(), jTextField5.getText(), 0, jTextField2.getText(), jTextField3.getText(), datef, datef, user);
            int isUpdate = SupplierController.update(supplier);
            if (isUpdate == 1) {
    ...
    try {
        int isDelete = SupplierController.delete(sup_id);
        if (isDelete == 1) {
