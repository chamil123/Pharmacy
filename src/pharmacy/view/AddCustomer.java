...
public class AddCustomer extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // User user=UserController.getUserById(1);
        ...
        Customer customer = new Customer(null, jTextField1.getText(), jTextField2.getText(), jTextField3.getText(),jTextArea1.getText(), jTextField5.getText(),jTextField4.getText(),0, datef, datef);

        int isAdded = CustomerController.save(customer);
        if (isAdded == 1) {
            JOptionPane.showMessageDialog(null, "Successfully added " + "" + jTextField1.getText());
        }
