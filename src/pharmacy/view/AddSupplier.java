...
public class AddSupplier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(878, 452));
...
//        Brand brand = BrandController.getBrand_id_byName(jComboBox1.getSelectedItem().toString());
        ...
        Supplier supplier = new Supplier(null, jTextField1.getText(), jTextArea1.getText(), jTextField4.getText(),jTextField5.getText(), 0,jTextField2.getText(),jTextField3.getText(), datef, datef,user);

        int isAdded = SupplierController.save(supplier);
        if (isAdded == 1) {
